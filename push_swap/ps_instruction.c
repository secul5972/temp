...
/*   Updated: 2021/07/09 00:58:56 by seungcoh         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "push_swap.h"

void	s_ins(t_list *a, t_list *b, int h_flag)
{
	t_list *curr;
	t_list *first_node;
...
void	p_ins(t_list *a, t_list*b, int h_flag)
{
	t_list *push_head;
	t_list *pop_head;
...
void	r_ins(t_list *a, t_list *b, int h_flag, int rev_flag)
{
	if (rev_flag == 0)
	{
		if (h_flag & 1)
